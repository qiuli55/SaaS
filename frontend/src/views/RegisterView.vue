    ...
    <div class="login-right">
      <div class="login-form-wrapper">
        ...
        <form @submit.prevent="handleRegister">
          ...
          <div class="form-group"><label class="form-label">密码 <span style="color:var(--error)">*</span></label><input v-model="form.password" type="password" placeholder="至少6位" class="form-input" required /></div>
