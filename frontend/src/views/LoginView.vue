    ...
    <div class="login-left">
      ...
      <div class="login-features">
        <div class="login-feature">
          <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M7 13l-4-4 4-4"/><path d="M11 5l4 4-4 4"/><path d="M10 3L8 15"/></svg>
          AI 智能生成起诉状、答辩状、律师函等标准法律文书
        </div>
        <div class="login-feature">
          <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="9" cy="9" r="8"/><path d="M6 9l2 2 4-4"/></svg>
          法条引用自动校验，确保文书引用法条真实准确
        </div>
        <div class="login-feature">
          <svg viewBox="0 0 18 18" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="2" y="4" width="14" height="11" rx="1"/><path d="M6 8h6M6 11h4"/></svg>
